package cn.haokuai.supershop.app.widget;
...
public class CustomerScrollView extends ScrollView {
	...
	private static final int MAX_SCROLL_HEIGHT = 200;// �?大滑动距�?
	private static final float SCROLL_RATIO = 0.3f;// 阻尼系数,越小阻力就越�?

	public CustomerScrollView(Context context) {
		super(context);
		this.mContext = context;
		mView.scrollTo(0, -280);
	}
